var data = [ {
  ...
  "to_do_page"    : [
    {
    "alert"       : ["This is your to-do list.","You have to work through the items below. If you don't you might not get paid.","Completed items appear in your <a href='/pyi11/no_page_exists'>journal.</a>"],
...
"verify_identity"    : [
  {
    ...
    "toDoTask"  : "To do",
    "panelText" : "You'll need to <a href='/pyi11/to_do_page'>book an ID interview</a> at a jobcentre.",
    "button"    : "Next"
},
],
  "how_verify"    : [
    {
      ...
      "radios"    : [{"value": "Use your bank account to help prove your identity - this could save you time in the job centre"},{"value": "Bring your documents into a jobcentre"}],
      "toDoTask"  : "To do",
      "panelText" : "You'll need to <a href='/pyi11/to_do_page'>book an ID interview</a> at a jobcentre.",
      "button"    : "Next"
  },
...
"404"        : [
  {
    ...
    "additional"  : "Or go back to the <a href='/pyi11/to_do_page'>Universal Credit sign in page.</a>"
    }
],
"expired"    : [
  {
