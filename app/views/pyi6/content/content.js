var data = [ {
  ...
  "to_do_page"    : [
    {
    "alert"       : ["This is your to-do list.","You have to work through the items below. If you don't you might not get paid.","Completed items appear in your <a href='/pyi6/no_page_exists'>journal.</a>"],
  ...
  "how_verify"    : [
    {
      ...
      "revealContent" : "You can prove your identity online by having 1 penny paid into the bank account you use for Universal Credit.",
      "button"    : "Next"
  },
],
  "bank_details"  : [
